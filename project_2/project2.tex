...
\setlength{\textfloatsep}{2pt} % Vertical space below (above) [t] ([b]) floats
...
\ba
	...
	\frac{C_i(r)}{C_M}	&= \frac{Q}{6 D}   \frac{162}{11}  \frac{D}{Q} R^{-2} (\frac{1}{2} \frac{r^3}{R} - r^2 + R^2) \\
					...
					&= \frac{27}{11} \bigg [ \frac{1}{2}  (\frac{r}{R})^3 -  (\frac{r}{R})^2 + 1 \bigg ] \\
\ea
And 
\ba
	C_o(r)			&=   \frac{Q}{12 D} R^3 \frac{1}{r} \\
	\frac{C_o(r)}{C_M}	&=  \frac{Q}{12 D}  \frac{162}{11}  \frac{D}{Q} R^{-2}  R^3 \frac{1}{r}  \\
					&= \frac{27}{22} \frac{R}{r} \\
\ea
